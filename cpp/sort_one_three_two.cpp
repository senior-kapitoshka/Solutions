   ...
   (i>=100 && i%100==0)?std::pair<std::string,int>{mp[i/100]+" hundred"s,i}:
    ...
    {12,"twelve"s}
      ...
      std::sort(vp.begin(),vp.end(),[](auto lhs,auto rhs){
        ...
        return (std::to_string(lhs.second).front()=='4' && 
               std::to_string(rhs.second).front()=='4' &&
                std::to_string(lhs.second).size()!=std::to_string(rhs.second).size()
               )?std::to_string(lhs.second).size()<std::to_string(rhs.second).size():
        
                (std::to_string(lhs.second)[1]=='4' &&
               std::to_string(rhs.second)[2]=='4' &&
                   (std::to_string(rhs.second)[1]=='1' || std::to_string(rhs.second)[1]=='0') &&
                  std::to_string(lhs.second).size()==3 &&
                std::to_string(lhs.second).size()==std::to_string(rhs.second).size()
                 && std::to_string(rhs.second).front()==std::to_string(lhs.second).front()
               )?lhs.second<rhs.second:
        
        (std::to_string(rhs.second)[1]=='4' &&
               std::to_string(lhs.second)[2]=='4' &&
                   (std::to_string(lhs.second)[1]=='1' || std::to_string(lhs.second)[1]=='0') &&
                  std::to_string(lhs.second).size()==3 &&
                std::to_string(lhs.second).size()==std::to_string(rhs.second).size()
                 && std::to_string(rhs.second).front()==std::to_string(lhs.second).front()
               )?lhs.second>rhs.second:
